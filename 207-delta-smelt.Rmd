...
ddf[ddf==-1]<-NA
ddf2<-ddf %>% filter(X2 %in% mins$Position)
...
pdf("outputs/207/dsm-sex-heatmap.pdf")
pheatmap(m, labels_col = dm8$Sample, cluster_rows=TRUE, annotation_col = annot, width=12, height=8, cluster_cols = TRUE, legend=TRUE,
         fontsize_col = 6)
dev.off()
```
## Model2
