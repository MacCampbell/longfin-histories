...
#	-> Number of sites retained after filtering: 67766 
...
-minMaf 0.05 -minMapQ 20 -minQ 20 -GL 1 -doMajorMinor 1 -doMaf 1 -SNP_pval 1e-6 \
-doGeno 2 -doPost 1 -postCutoff 0.9 -doPlink 2  > outputs/305/snps.out 2> outputs/305/snps.err &
#	-> Number of sites retained after filtering: 68616 
...
#	-> Number of sites retained after filtering: 49346 
...
bcftools view  outputs/305/filtered.vcf.gz  -r 'lcl|scaffold_26':8.25e6- > outputs/305/vcfs/26-region.vcf
bcftools view  outputs/305/filtered.vcf.gz  -r 'lcl|scaffold_11':17e6- > outputs/305/vcfs/11-region.vcf
bcftools view  outputs/305/filtered.vcf.gz  -r 'lcl|scaffold_11':19e6- > outputs/305/vcfs/11-region-2.vcf
